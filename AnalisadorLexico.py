...
tokens = [
    "PLUS_PLUS", "MINUS_MINUS", "PLUS_ASSIGNMENT", "MINUS_ASSIGNMENT",
    "TIMES_ASSIGNMENT", "DIVIDE_ASSIGNMENT", "MODULE_ASSIGNMENT",
    "AND_ASSIGNMENT", "EXCLUSIVE_OR_ASSIGNMENT", "INCLUSIVE_OR_ASSIGNMENT",
    "PLUS", "MINUS", "TIMES", "DIVIDE", "MODULE", "LPAREN", "RPAREN", "ID",
    "NUMBER", "EQUAL", "ASSIGNMENT", "EXCLUSIVE_OR", "INCLUSIVE_OR",
    "LOGICAL_AND", "LOGICAL_OR", "AND", "NEGATION", "BOOLEAN_NEGATION",
    "LESS_OR_EQUAL", "DIFFERENT", "GREATER_OR_EQUAL", "LESS_THAN",
    "GREATER_THAN", "LBRACE", "RBRACE", "COMMA", "SEMICOLON"
